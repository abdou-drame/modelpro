...
async function seed() {
  ...
  const metiers = await Metier.bulkCreate([
    { nom: 'Tailleur', description: 'Confection de vêtements sur mesure pour hommes', actif: true },
    ...
    { nom: 'Tisserand', description: 'Tissage artisanal de bazin et kente', actif: true },
    { nom: 'Styliste', description: 'Création de collections mode africaine contemporaine', actif: true },
  ]);
  ...
  const artisanData = [
    ...
    { nom: 'Traoré', prenom: 'Ibrahim', tel: '0701000003', email: 'ibrahim@artisan.sn', metier: 'Brodeur', atelier: 'Broderie Traoré & Fils', loc: 'Bamako, Hippodrome', note: 4.6, avis: 28, desc: 'Brodeur traditionnel malinké, spécialiste de la broderie dorée sur grand boubou.', exp: 20, sub: 'actif' },
    { nom: 'Sow', prenom: 'Fatou', tel: '0701000004', email: 'fatou@artisan.sn', metier: 'Styliste', atelier: 'Studio Sow Moderne', loc: 'Dakar, Almadies', note: 4.7, avis: 41, desc: 'Styliste fusion afro-contemporaine, créations portées lors de la FIMA.', exp: 8, sub: 'actif' },
    { nom: 'Coulibaly', prenom: 'Seydou', tel: '0701000005', email: 'seydou@artisan.sn', metier: 'Tisserand', atelier: 'Tissage Coulibaly Kente', loc: 'Kumasi, Ghana', note: 4.5, avis: 19, desc: 'Tisserand traditionnel kente, pièces uniques réalisées sur métier à tisser manuel.', exp: 25, sub: 'inactif' },
    { nom: 'Barry', prenom: 'Mariama', tel: '0701000006', email: 'mariama@artisan.sn', metier: 'Couturière', atelier: 'Atelier Barry Guinée', loc: 'Conakry, Kaloum', note: 4.4, avis: 15, desc: 'Spécialiste des tenues de fêtes guinéennes et pagnes imprimés.', exp: 7, sub: 'actif' },
    { nom: 'Ndiaye', prenom: 'Ousmane', tel: '0701000007', email: 'ousmane@artisan.sn', metier: 'Tailleur', atelier: 'Grand Boubou Ndiaye', loc: 'Saint-Louis, Sénégal', note: 4.3, avis: 11, desc: 'Maître tailleur formé à l\'école de Saint-Louis, référence du grand boubou sénégalais.', exp: 18, sub: 'actif' },
    { nom: 'Camara', prenom: 'Bintou', tel: '0701000008', email: 'bintou@artisan.sn', metier: 'Brodeur', atelier: 'Broderie Camara Prestige', loc: 'Dakar, Médina', note: 4.6, avis: 22, desc: 'Spécialiste broderie machine et main sur wax, super wax et tissu de soie.', exp: 10, sub: 'actif' },
  ];
  ...
  // ── Créations / Catalogue (24) ────────────────────────────────────────────
  const creationDefs = [
    // artisan 0 — Diallo Tailleur
    { aIdx: 0, titre: 'Grand Boubou Brodé Or', desc: 'Boubou en bazin blanc avec broderie dorée sur col et poignets. Livré avec pantalon assorti.', prix: 85000, delai: '10-14 jours', cat: 'Boubou', photoIdx: 0 },
    { aIdx: 0, titre: 'Costume Trois Pièces Africain', desc: 'Veste, gilet et pantalon en kente tissé main. Idéal pour cérémonies et mariages.', prix: 120000, delai: '14-21 jours', cat: 'Costume', photoIdx: 1 },
    { aIdx: 0, titre: 'Tenue Damask Classique', desc: 'Ensemble complet en damask senegalais, coupe droite traditionnelle.', prix: 45000, delai: '7-10 jours', cat: 'Ensemble', photoIdx: 2 },
    // artisan 1 — Koné Couturière
    { aIdx: 1, titre: 'Robe de Mariée Bazin', desc: 'Robe longue en bazin riche blanc cassé avec broderie florale argentée. Sur mesure exclusivement.', prix: 250000, delai: '21-30 jours', cat: 'Mariage', photoIdx: 3 },
    { aIdx: 1, titre: 'Tenue de Cérémonie Wax', desc: 'Robe bustier et veste longue assortie en wax Vlisco premium. Coloris au choix.', prix: 75000, delai: '10-14 jours', cat: 'Cérémonie', photoIdx: 4 },
    { aIdx: 1, titre: 'Ensemble Pagne Gala', desc: 'Jupe longue et corsage en pagne imprimé, finitions main soignées.', prix: 55000, delai: '7-10 jours', cat: 'Ensemble', photoIdx: 5 },
    // artisan 2 — Traoré Brodeur
    { aIdx: 2, titre: 'Broderie Grand Boubou Malinké', desc: 'Broderie traditionnelle sur boubou existant ou tissu fourni. Motifs géométriques dorés.', prix: 35000, delai: '5-7 jours', cat: 'Broderie', photoIdx: 6 },
    { aIdx: 2, titre: 'Nappe Brodée Cérémonie', desc: 'Nappe de table 3m x 1.5m avec broderie florale blanche sur fond ivoire.', prix: 60000, delai: '10-14 jours', cat: 'Décoration', photoIdx: 7 },
    // artisan 3 — Sow Styliste
    { aIdx: 3, titre: 'Collection Sahel — Robe Moderne', desc: 'Robe asymétrique inspirée des dunes du Sahel. Tissu organza avec sous-robe pagne.', prix: 95000, delai: '14-21 jours', cat: 'Prêt-à-porter', photoIdx: 0 },
    { aIdx: 3, titre: 'Kimono Wax Contemporain', desc: 'Kimono longue traîne en wax imprimé, doublure soie. Pièce unique numérotée.', prix: 130000, delai: '14-21 jours', cat: 'Prêt-à-porter', photoIdx: 1 },
    { aIdx: 3, titre: 'Ensemble Pantalon Crop-Top Kente', desc: 'Pantalon large et top court en kente moderne, coupe contemporaine.', prix: 68000, delai: '10-12 jours', cat: 'Ensemble', photoIdx: 2 },
    // artisan 4 — Coulibaly Tisserand
    { aIdx: 4, titre: 'Écharpe Kente Royale', desc: 'Écharpe tissée main en soie et coton, motifs royaux ashanti. 3m x 30cm.', prix: 45000, delai: '7-10 jours', cat: 'Accessoire', photoIdx: 3 },
    { aIdx: 4, titre: 'Tissu Kente au Mètre', desc: 'Tissu kente authentique, minimum 2 mètres par commande. Coloris variés.', prix: 28000, delai: '5-7 jours', cat: 'Tissu', photoIdx: 4 },
    // artisan 5 — Barry Couturière
    { aIdx: 5, titre: 'Tenue de Fête Guinéenne', desc: 'Ensemble complet (robe + foulard + ceinture) en bazin teint main aux couleurs vives.', prix: 65000, delai: '10-14 jours', cat: 'Cérémonie', photoIdx: 5 },
    { aIdx: 5, titre: 'Robe Pagne Courte', desc: 'Robe droite mi-cuisses en pagne imprimé africain. Disponible en plusieurs coloris.', prix: 28000, delai: '5-7 jours', cat: 'Prêt-à-porter', photoIdx: 6 },
    // artisan 6 — Ndiaye Tailleur
    { aIdx: 6, titre: 'Boubou Saint-Louisien Classique', desc: 'Boubou traditionnel 7m en bazin bleu roi, broderie blanche sur encolure. Style Saint-Louis.', prix: 72000, delai: '7-10 jours', cat: 'Boubou', photoIdx: 7 },
    { aIdx: 6, titre: 'Tenue Korité Complète', desc: 'Ensemble boubou + calot + babouches assorties pour les grandes fêtes religieuses.', prix: 115000, delai: '14-18 jours', cat: 'Cérémonie', photoIdx: 0 },
    // artisan 7 — Camara Brodeur
    { aIdx: 7, titre: 'Broderie Machine Super-Wax', desc: 'Personnalisation par broderie machine sur tout tissu fourni par le client.', prix: 25000, delai: '3-5 jours', cat: 'Broderie', photoIdx: 1 },
    { aIdx: 7, titre: 'Robe de Soirée Brodée', desc: 'Robe longue en tissu de soie avec broderie florale multicolore réalisée main.', prix: 140000, delai: '21-28 jours', cat: 'Soirée', photoIdx: 2 },
  ];

  const creations: Creation[] = [];
  for (const c of creationDefs) {
    const extras = [PHOTOS_CREATION[(c.photoIdx + 1) % PHOTOS_CREATION.length], PHOTOS_CREATION[(c.photoIdx + 2) % PHOTOS_CREATION.length]];
    const cr = await Creation.create({
      artisanId: artisanProfiles[c.aIdx].id,
      titre: c.titre,
      description: c.desc,
      photoUrl: PHOTOS_CREATION[c.photoIdx],
      prixEstimatif: c.prix,
      delaiEstime: c.delai,
      categorie: c.cat,
      photos: JSON.stringify(extras),
