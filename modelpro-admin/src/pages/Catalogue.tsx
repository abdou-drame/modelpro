...
export default function Catalogue() {
  ...
  const paginationMeta = modelsData ? { page: (modelsData as any).page ?? 1, totalPages: (modelsData as any).totalPages ?? 1, total: (modelsData as any).total ?? models.length, limit: (modelsData as any).limit ?? 12 } : null
