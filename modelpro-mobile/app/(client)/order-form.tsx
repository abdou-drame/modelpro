...
const schema = z.object({
  ...
  mesures: z.record(z.string(), z.string()).optional(),
})
  ...
  const mutation = useMutation({
    mutationFn: (data: FormData) =>
      ordersApi.create({
        ...
        mesures: JSON.stringify(data.mesures ?? {}),
      }),
    ...
    onSuccess: () => {
      ...
      showAlert(
        ...
        'Votre demande a été transmise à l’artisan. Vous serez notifié dès qu’il aura accepté votre commande.',
        [{ text: 'Voir mes commandes', onPress: () => router.replace('/(client)/orders') }]
      )
    },
    onError: (e: any) => {
